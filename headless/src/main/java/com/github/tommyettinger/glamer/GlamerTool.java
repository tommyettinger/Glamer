...
public class GlamerTool extends ApplicationAdapter {
    ...
    Roboto-Regular.ttf:
    java -jar GlamerTool.jar assets/Roboto-Regular.ttf 32 msdf 1 40 45 4 9 38
    Roboto-Bold.ttf:
    java -jar GlamerTool.jar assets/Roboto-Bold.ttf 32 msdf 1 40 45 4 9 38
     */
